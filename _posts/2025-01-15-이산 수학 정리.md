...
-   여러 가지 이항 관계: 집합 X상의 이항 관계
    ...
    -   대칭성(Symmetricity): ∀x,y ∈ X, xRy -> yRx
        >   *반대칭성과 비대칭성은 대칭성이 아니다를 의미하지 않음*   
            <a href = "http://bigdata.dongguk.ac.kr/lectures/disc_math/_book/figures/relationship_관계1.png"><img src = "http://bigdata.dongguk.ac.kr/lectures/disc_math/_book/figures/relationship_관계1.png" height ="400" width ="500"></a>
...
-   그래프의 종류
    ...
    -   평면 그래프(Planar Graph)
        ...
        >   *r = e - v + 2*   
        >   **Planar Graph**   
        <a href="https://commons.wikimedia.org/wiki/File:Butterfly_graph.svg#/media/File:Butterfly_graph.svg"><img src="https://upload.wikimedia.org/wikipedia/commons/f/f9/Butterfly_graph.svg" alt="Butterfly graph.svg" height="107" width="227"></a><br>By <a href="//commons.wikimedia.org/wiki/User:Koko90" title="User:Koko90">Koko90</a> - <span class="int-own-work" lang="en">Own work</span>, <a href="https://creativecommons.org/licenses/by-sa/3.0" title="Creative Commons Attribution-Share Alike 3.0">CC BY-SA 3.0</a>, <a href="https://commons.wikimedia.org/w/index.php?curid=7832746">Link</a>   
        >   **Nonplanar Graph**   
        <a href="https://commons.wikimedia.org/wiki/File:Complete_graph_K5.svg#/media/File:Complete_graph_K5.svg"><img src="https://upload.wikimedia.org/wikipedia/commons/c/cf/Complete_graph_K5.svg" alt="Complete graph K5.svg" height="160" width="180"></a><br>By <a href="//commons.wikimedia.org/wiki/User:Dbenbenn" title="User:Dbenbenn">David Benbennick</a> wrote this file. - <span class="int-own-work" lang="en">Own work</span>, Public Domain, <a href="https://commons.wikimedia.org/w/index.php?curid=511709">Link</a>
    -   완전 그래프(Complete Graph)
        >   G = (V, E)에 있는 모든 정점 u,v 간에 변이 있는 그래프   
        <a href="https://commons.wikimedia.org/wiki/File:5-simplex_graph.svg#/media/File:5-simplex_graph.svg"><img src="https://upload.wikimedia.org/wikipedia/commons/e/e9/5-simplex_graph.svg" alt="5-simplex graph.svg" height="195" width="223"></a><br>By <a href="//commons.wikimedia.org/wiki/User:Koko90" title="User:Koko90">Koko90</a> - <span class="int-own-work" lang="en">Own work</span>, <a href="https://creativecommons.org/licenses/by-sa/3.0" title="Creative Commons Attribution-Share Alike 3.0">CC BY-SA 3.0</a>, <a href="https://commons.wikimedia.org/w/index.php?curid=10947365">Link</a>
    -   정규 그래프(Regular Graph)
        >   G = (V, E)에 있는 모든 정점의 차수가 같은 그래프   
        <a href="https://commons.wikimedia.org/wiki/File:1-regular_graph.svg#/media/File:1-regular_graph.svg"><img src="https://upload.wikimedia.org/wikipedia/commons/c/ce/1-regular_graph.svg" alt="1-regular graph" height="160" width="138"></a><br>By <a href="//commons.wikimedia.org/w/index.php?title=User:0x24a537r9&amp;action=edit&amp;redlink=1" class="new" title="User:0x24a537r9 (page does not exist)">0x24a537r9</a> - <span class="int-own-work" lang="en">Own work</span>, <a href="https://creativecommons.org/licenses/by-sa/3.0" title="Creative Commons Attribution-Share Alike 3.0">CC BY-SA 3.0</a>, <a href="https://commons.wikimedia.org/w/index.php?curid=12523449">Link</a>
    -   이분 그래프(Bipartite Graph)
        >   인접한 정점끼리 서로 다른 색으로 칠해서 모든 정점을 두 가지 색으로만 칠할 수 있는 그래프   
        <a href="https://commons.wikimedia.org/wiki/File:Simple_bipartite_graph;_two_layers.svg#/media/File:Simple_bipartite_graph;_two_layers.svg"><img src="https://upload.wikimedia.org/wikipedia/commons/b/b9/Simple_bipartite_graph%3B_two_layers.svg" alt="Simple bipartite graph; two layers.svg" height="161" width="325"></a><br>By <span typeof="mw:File"><a href="//commons.wikimedia.org/wiki/File:Watchduck.svg" class="mw-file-description"></a></span><a href="//commons.wikimedia.org/wiki/User:Watchduck" title="User:Watchduck">Watchduck</a><span style="color: gray; font-size: 80%;">You can name the author as "T. Piesk", "Tilman Piesk" or "Watchduck".</span> - <span class="int-own-work" lang="en">Own work</span>, <a href="https://creativecommons.org/licenses/by-sa/4.0" title="Creative Commons Attribution-Share Alike 4.0">CC BY-SA 4.0</a>, <a href="https://commons.wikimedia.org/w/index.php?curid=121779105">Link</a>   
