...
-   여러 가지 이항 관계: 집합 X상의 이항 관계
    ...
    -   대칭성(Symmetricity): ∀x,y ∈ X, xRy -> yRx
        >   *반대칭성과 비대칭성은 대칭성이 아니다를 의미하지 않음*   
            <a href = "https://bigdata.dongguk.ac.kr/lectures/disc_math/_book/figures/relationship_관계1.png"><img src = "https://bigdata.dongguk.ac.kr/lectures/disc_math/_book/figures/relationship_관계1.png" alt = "비대칭성 ⊂ 반대칭성을 보여주는 이미지" height ="400" width ="500"></a>
